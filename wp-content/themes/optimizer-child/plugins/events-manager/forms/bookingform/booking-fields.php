...
<?php if( !is_user_logged_in() && apply_filters('em_booking_form_show_register_form',true) ): ?>
	...
	<p>
		<label for='user_name'><?php _e('Name (obligatoire)','events-manager') ?></label>
		<input type="text" name="user_name" id="user_name" class="input" value="<?php if(!empty($_REQUEST['user_name'])) echo esc_attr($_REQUEST['user_name']); ?> "required="true" />
	</p>
	<p>
	...
	<p>
		<label for='user_email'><?php _e('E-mail (obligatoire)','events-manager') ?></label>
		<input type="text" name="user_email" id="user_email" class="input" value="<?php if(!empty($_REQUEST['user_email'])) echo esc_attr($_REQUEST['user_email']); ?>"required="true"  />
	</p>
...
<?php endif; ?>
<p>
	<label for='booking_comment'><?php _e('Comment', 'events-manager') ?></label><br/>
